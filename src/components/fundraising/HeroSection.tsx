        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-10">
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-base lg:text-lg text-blue-100 leading-relaxed max-w-2xl font-light">
            ...
            <div className="relative">
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-3 border border-white/20 shadow-2xl transform hover:scale-105 transition-transform duration-500 max-w-xs mx-auto lg:mx-0">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <div className="w-5 h-5 bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg flex items-center justify-center shadow-lg">
                      <Globe className="w-2.5 h-2.5 text-white" />
                    </div>
                    <div>
                      <h3 className="text-xs font-bold text-white mb-0.5">Ready to Scale?</h3>
