    ...
    <section className="bg-gray-50 py-[60px]">
      <div className="container-custom">
        ...
        >
          ...
          <h3 className="heading-md mb-4">Case Studies</h3>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            See how our incorporation services have helped businesses establish strong foundations and achieve their growth objectives.
          </p>
        </motion.div>
