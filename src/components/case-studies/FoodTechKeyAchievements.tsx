  ...
  const achievements = [
    {
      ...
      items: [
        "Collaborated with the CEO and investors for a profitable financial plan.",
        "Improved key metrics with a performance system."
      ]
    },
    {
      title: "Working Capital Mastery",
      items: [
        "Strategically managed working capital.",
        "Enhanced cash flow and financial reporting."
      ]
    },
    {
      title: "Efficient Consolidation",
      items: [
        "Streamlined financial reporting with automated bookkeeping.",
        "Ensured accurate EBITDA representation."
      ]
    }
  ];
