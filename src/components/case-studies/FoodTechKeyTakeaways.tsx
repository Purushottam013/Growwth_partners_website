...
export const FoodTechKeyTakeaways = () => {
  const achievements = [
    "Strategic planning and meticulous execution, ensuring every aspect of the business was optimised.",
    "Continual collaboration and guidance, enabling the client to adapt to evolving market demands effectively.",
    "Implementation of data-driven strategies, ensuring decisions were based on insights, leading to informed and impactful choices."
  ];
