  ...
  return <section className="py-[40px]">
      <div className="container-custom mb-20">
        <div className="text-center mb-10">
          ...
          <Button onClick={() => setContactModalOpen(true)} className="bg-brand-orange hover:bg-brand-orange/90 text-white px-8 py-6 text-lg font-medium rounded-full">
            Get Started
          </Button>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-[40px]">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 duration-300 h-full">
