    ...
    >
      ...
      <div className="container-custom">
        ...
        once: true
          ...
          {services.map((service, index) => <motion.div key={index} variants={cardVariants} transition={{
          duration: 0.5
              ...
              <Card className={`h-full transition-all duration-300 overflow-hidden ${hoveredCard === index ? "shadow-xl transform -translate-y-2 border-brand-orange" : "shadow-md hover:shadow-lg"}`}>
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <Button variant="link" className="p-0 h-auto flex items-center text-brand-orange font-medium hover:text-brand-orange/80 justify-start" asChild>
                    <a href={service.link}>
