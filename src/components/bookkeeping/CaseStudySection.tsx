...
export const CaseStudySection = () => {
  const caseStudies = [{
    ...
    description: "Strategic planning and meticulous execution, ensuring every aspect of the business was optimised.​",
    url: "https://growwthpartners.com/portfolio/fueling-rapid-growth-in-the-food-tech-space/"
  }, {
  ...
  return <section className="bg-white py-[60px]">
      <div className="container-custom">
        ...
        once: true
          ...
          <span className="inline-block px-4 py-1 bg-[#FEF7CD] rounded-full text-sm font-semibold mb-4 text-orange-500">Success Stories</span>
              ...
              <a href={study.url} target="_blank" rel="noopener noreferrer" className="block h-full group">
                <Card className="bg-gray-50 hover:shadow-xl transition-all duration-300 h-full hover:-translate-y-2 border-0 shadow-md overflow-hidden">
                  <CardContent className="p-8">
                    <h4 className="text-xl font-bold mb-4 text-brand-dark group-hover:text-brand-green transition-colors">{study.title}</h4>
