  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 to-white py-[60px]">
      <div className="container-custom">
        ...
        >
          <h2 className="heading-lg mb-4">From our experts! Read now</h2>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Insights and advice from our financial experts to help your business
            thrive
          </p>
        </motion.div>
              ...
              >
                <Card className="bg-white hover:shadow-xl transition-all duration-300 h-full hover:-translate-y-1 border border-gray-100">
                  <CardContent className="p-6">
                    <h4 className="text-xl font-bold mb-3 text-brand-dark group-hover:text-brand-green transition-colors">
                      {blog.title}
                    </h4>
