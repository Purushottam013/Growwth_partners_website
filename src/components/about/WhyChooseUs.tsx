      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-[#DBE9FE]/10 to-transparent rounded-bl-full transition-colors duration-300 group-hover:from-[#DBE9FE]/20" />
