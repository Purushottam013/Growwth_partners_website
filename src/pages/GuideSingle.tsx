...
const GuideSingle = () => {
  ...
  if (slug === "pitching-to-investors-guide") {
  ...
  } else if (slug === "comprehensive-bookkeeping-practices-guide") {
    // Bookkeeping guide content
    keyTakeawayImages = [
      "/lovable-uploads/ff64989c-dab9-4050-814e-d90bca79f42b.png", // Using the same images as financial reporting
      "/lovable-uploads/15e6b360-d5dd-4d93-8dd8-86e3b6815a2c.png",
      "/lovable-uploads/ff10cb0e-544a-4e37-b61b-8e4174ede681.png",
      "/lovable-uploads/29d7a505-65ef-443d-bc30-78185338c79b.png",
      "/lovable-uploads/7950ef2b-fec5-470f-8003-13b293af4b08.png"
    ...
    sections = [
      { title: "Introduction", content: `<p>No business can prosper without bookkeeping. It is the lifeblood of any prosperous enterprise undertaking accurate financial decisions and staying within the law. But it is also one of those things that are often overlooked in small businesses.</p>
      ...
      { title: "What is Bookkeeping?", content: `<p>This refers to systematically recording, organising and maintaining all financial transactions of a company so that they may reflect sales, purchases, and income. The main aim is usually accuracy and currency accessibility.</p>
        <div class="my-8 flex justify-center">
          <img src="/lovable-uploads/b944c7f0-3247-4820-a5f5-04447ddd95df.png" alt="Differences between Bookkeeping & Accounting" class="w-full max-w-3xl rounded-lg shadow-md" />
        </div>
        <div class="bg-blue-50 p-4 rounded-lg mb-6">
          <p class="font-semibold text-blue-800 mb-2">Pro-tip:</p>
        ...
        <h4 class="text-xl font-semibold mb-3">Methods of Bookkeeping</h4>
        ...
        <h5 class="text-lg font-medium mt-4 mb-2">Single-Entry Bookkeeping</h5>
        ...
        <h5 class="text-lg font-medium mt-4 mb-2">Double-Entry Bookkeeping</h5>
        ...
        <div class="bg-gradient-to-r from-indigo-50 to-purple-50 p-4 rounded-lg mt-6">
          <p class="italic">Feeling overwhelmed by bookkeeping? Growwth Partners' expert services can help manage your books accurately. <a href="/contact" class="text-primary hover:underline">Contact us today!</a></p>
        </div>` },
      { title: "Importance of Bookkeeping", content: `<h4 class="text-xl font-semibold mb-3">Legal Compliance</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Financial Management</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Investor Confidence</h4>
        ...
        <div class="my-8 flex justify-center">
          <img src="/lovable-uploads/670975c0-2bce-4c59-b3d4-e099096cd151.png" alt="Role of a Bookkeeper" class="w-full max-w-3xl rounded-lg shadow-md" />
        </div>
        <div class="bg-blue-50 p-4 rounded-lg mb-6">
          <p class="font-semibold text-blue-800 mb-2">Pro-tip:</p>
      ...
      { title: "Basic Bookkeeping Terms", content: `<h4 class="text-xl font-semibold mb-3">Assets</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Liabilities</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Equity</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Revenue</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Expenses</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Ledger</h4>
      ...
      { title: "Comprehensive Steps in Bookkeeping Process", content: `<h4 class="text-xl font-semibold mb-3">Analysing Financial Transactions</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Recording Transactions</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Posting to the Ledger</h4>
        ...
        <div class="my-8 flex justify-center">
          <img src="/lovable-uploads/bbca5cc5-30d4-410b-a885-0ac4b428f298.png" alt="7 Step Guide to Effective Bookkeeping" class="w-full max-w-3xl rounded-lg shadow-md" />
        </div>
        <h4 class="text-xl font-semibold mb-3 mt-5">Preparing Trial Balance</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Adjusting Entries</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Preparing Financial Statements</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Closing the Books</h4>
      ...
      { title: "Common Challenges in Bookkeeping", content: `<h4 class="text-xl font-semibold mb-3">Complexity</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Time-Consuming</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Errors and Omissions</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Compliance Issues</h4>
        ...
        <h4 class="text-xl font-semibold mb-3 mt-5">Security Concerns</h4>
        ...
        <div class="bg-gradient-to-r from-indigo-50 to-purple-50 p-4 rounded-lg mt-6">
          <p class="italic">Bookkeeping challenges can hinder your business growth. Let Growwth Partners handle your bookkeeping needs, ensuring accuracy and compliance. <a href="/contact" class="text-primary hover:underline">Contact us today!</a></p>
        </div>` },
      { title: "Summary", content: `<p>Bookkeeping is a vital part of running a successful business. It gives you insight into your financial health, keeps you compliant with the law and helps build trust with investors. By following this comprehensive guide, you will have a better understanding of what bookkeeping involves and why it's so important for any healthy business.</p>
